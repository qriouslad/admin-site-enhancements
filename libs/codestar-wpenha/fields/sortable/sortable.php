 ...
 *
 */
if ( ! class_exists( 'WPENHA_CSF_Field_sortable' ) ) {
  class WPENHA_CSF_Field_sortable extends WPENHA_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="csf-sortable-item">';
          ...
          WPENHA_CSF::field( $field, $field_value, $unique_id, 'field/sortable' );
