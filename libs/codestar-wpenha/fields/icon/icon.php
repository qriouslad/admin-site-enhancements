 ...
 *
 */
if ( ! class_exists( 'WPENHA_CSF_Field_icon' ) ) {
  class WPENHA_CSF_Field_icon extends WPENHA_CSF_Fields {
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'WPENHA_CSF_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'WPENHA_CSF_Field_icon', 'add_footer_modal_icon' ) );
    }
