 ...
 *
 */
if ( ! class_exists( 'WPENHA_CSF_Field_accordion' ) ) {
  class WPENHA_CSF_Field_accordion extends WPENHA_CSF_Fields {
      ...
      foreach ( $this->field['accordions'] as $key => $accordion ) {
        ...
        echo '<div class="csf-accordion-item">';
          ...
          foreach ( $accordion['fields'] as $field ) {
            ...
            WPENHA_CSF::field( $field, $field_value, $unique_id, 'field/accordion' );
