 ...
 *
 */
if ( ! class_exists( 'WPENHA_CSF_Field_tabbed' ) ) {
  class WPENHA_CSF_Field_tabbed extends WPENHA_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $this->field['tabs'] as $key => $tab ) {
        ...
        foreach ( $tab['fields'] as $field ) {
          ...
          WPENHA_CSF::field( $field, $field_value, $unique_id, 'field/tabbed' );
