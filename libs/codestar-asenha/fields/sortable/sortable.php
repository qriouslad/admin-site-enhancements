 ...
 *
 */
if ( ! class_exists( 'ASENHA_CSF_Field_sortable' ) ) {
  class ASENHA_CSF_Field_sortable extends ASENHA_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="csf-sortable-item">';
          ...
          ASENHA_CSF::field( $field, $field_value, $unique_id, 'field/sortable' );
