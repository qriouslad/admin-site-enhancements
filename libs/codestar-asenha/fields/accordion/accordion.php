 ...
 *
 */
if ( ! class_exists( 'ASENHA_CSF_Field_accordion' ) ) {
  class ASENHA_CSF_Field_accordion extends ASENHA_CSF_Fields {
      ...
      foreach ( $this->field['accordions'] as $key => $accordion ) {
        ...
        echo '<div class="csf-accordion-item">';
          ...
          foreach ( $accordion['fields'] as $field ) {
            ...
            ASENHA_CSF::field( $field, $field_value, $unique_id, 'field/accordion' );
