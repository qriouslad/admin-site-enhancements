 ...
 *
 */
if ( ! class_exists( 'ASENHA_CSF_Field_icon' ) ) {
  class ASENHA_CSF_Field_icon extends ASENHA_CSF_Fields {
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'ASENHA_CSF_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'ASENHA_CSF_Field_icon', 'add_footer_modal_icon' ) );
    }
