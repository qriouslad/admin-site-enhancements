 ...
 *
 */
if ( ! class_exists( 'ASENHA_CSF_Field_typography' ) ) {
  class ASENHA_CSF_Field_typography extends ASENHA_CSF_Fields {
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-webfontloader' ) ) {
        ...
        ASENHA_CSF::include_plugin_file( 'fields/typography/google-fonts.php' );
      ...
      if ( $is_google ) {
        ...
        if ( $font_weight || $font_style ) {
          ...
          if ( ! empty( $style ) ) {
            ...
            ASENHA_CSF::$webfonts[$method][$font_family][$style] = $style;
          }
        } else {
          ASENHA_CSF::$webfonts[$method][$font_family] = array();
        }
        ...
        if ( ! empty( $this->value['extra-styles'] ) ) {
          foreach ( $this->value['extra-styles'] as $extra_style ) {
            if ( ! empty( $extra_style ) ) {
              ...
              ASENHA_CSF::$webfonts[$method][$font_family][$extra_style] = $extra_style;
            }
          }
        }
        ...
        if ( ! empty( $this->value['subset'] ) ) {
          ...
          foreach ( $this->value['subset'] as $subset ) {
            if( ! empty( $subset ) ) {
              ASENHA_CSF::$subsets[$subset] = $subset;
            }
          }
        }
