 ...
 *
 */
if ( ! class_exists( 'ASENHA_CSF_Field_tabbed' ) ) {
  class ASENHA_CSF_Field_tabbed extends ASENHA_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $this->field['tabs'] as $key => $tab ) {
        ...
        foreach ( $tab['fields'] as $field ) {
          ...
          ASENHA_CSF::field( $field, $field_value, $unique_id, 'field/tabbed' );
